<form class="mx-auto mt-2 space-y-2" wire:submit.prevent="{{ $method }}">
    <div class="sm:w-full">
        <label for="project" class="block text-md text-white">Nombre del proyecto</label>
        <div class="mt-2">
    ...
    <div class="sm:w-full">
        <label for="description" class="block text-md text-white">Descripción del proyecto</label>
        <div class="mt-2">
